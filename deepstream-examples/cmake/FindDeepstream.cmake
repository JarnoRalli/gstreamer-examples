...
if(Deepstream_INCLUDE_DIR AND EXISTS "${Deepstream_INCLUDE_DIR}/nvds_version.h")
    ...
    string(REGEX REPLACE "^#define NVDS_VERSION_MAJOR ([0-9]+).*$" "\\1" Deepstream_VERSION_MAJOR_ "${Deepstream_MAJOR}")
    string(REGEX REPLACE "^#define NVDS_VERSION_MINOR ([0-9]+).*$" "\\1" Deepstream_VERSION_MINOR_ "${Deepstream_MINOR}")
    string(REGEX REPLACE "^#define NVDS_VERSION_MICRO ([0-9]+).*$" "\\1" Deepstream_VERSION_MICRO_ "${Deepstream_MICRO}")
    set(Deepstream_VERSION_STRING "${Deepstream_VERSION_MAJOR_}.${Deepstream_VERSION_MINOR_}.${Deepstream_VERSION_MICRO_}" CACHE STRING "Deepstream version" FORCE)
    set(Deepstream_VERSION_MAJOR ${Deepstream_VERSION_MAJOR_} CACHE STRING "Deepstream version, major" FORCE)
    set(Deepstream_VERSION_MINOR ${Deepstream_VERSION_MINOR_} CACHE STRING "Deepstream version, minor" FORCE)
endif()
